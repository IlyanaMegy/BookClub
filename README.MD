...
<div align="center">
  <img src="srcs/screens/home.png" alt="Home Page Preview" style="max-width: 80%; margin: 10px 0;" />
  <img src="srcs/screens/log.png" alt="Login Page Preview" style="max-width: 80%;margin: 10px 0;" />
  <img src="srcs/schema/bdd.png" alt="Schema BDD" style="max-width: 80%;margin-top: 100px 0;" />
</div>
...
Les langages utilisés pour développer ce site sont : HTML5, CSS3, JS, SQL et PHP.
...
Pour ça il vous faudra télécharger un logiciel permettant de mettre en place un serveur Web local.
...
Dans une première solution je vous montre comment créer la base de donnée `bookclub` qui sera vide de donnée, mais ensuite je vous montrerai comment importer ma propre base de données remplie de données que j'ai exporté en format sql dans le dossier `BookClub`.

- Créez la base de donnée vide sur PhpMyAdmin
...
Dans votre barre de recherche aller sur `http://localhost:80/BookClub/php/`, cela devrait vous emmener sur la page d'accueil.
...
> `http://localhost:80/BookClub/php/inscription_admin.php`. Cette page
